    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form class="space-y-6" action="/register" method="POST">
        ...
        <div>
          ...
          <div class="mt-2">
            <input name="email" type="text"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a href="/" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Login from here</a>
      </p>
    </div>
  </div>
